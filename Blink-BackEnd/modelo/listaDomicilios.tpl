<div id="one">
    <ul style="padding-left: 0;"data-role="listview" id="lista1" class="ui-listview-outer" data-inset="false">
        ...
        if($p['idMensajero'] == NULL || $p['idMensajero'] == ""){
            ...
            $nombreMensajero = $m->getNombres()." ".$m->getApellidos();
        }
        ?>
        ...
        <center><a href="#popupUbicacion" onclick="verEnMapa('<?php echo $latR; ?>', '<?php echo $lngR; ?>', '<?php echo $latU; ?>', '<?php echo $lngU; ?>')" class="ui-btn ui-shadow ui-corner-all ui-icon-location ui-btn-icon-right boton">Ubicar en Mapa</a></center>
        <?php if($p['clave']== ""  || $p['clave']== NULL){ ?>
        <div class="ui-grid-a">
        ...
        <p><b>Mensajero: </b><a href="#popupAsignarMensajero" onclick="popAsignarDomicilio(<?php echo $p['idDomicilio']; ?>)" class="ui-btn ui-shadow ui-corner-all boton"><?php echo $nombreMensajero; ?></a>
        </p>
        ...
        <center><a href="#popupUbicacion" onclick="verEnMapa2('<?php echo $latU; ?>', '<?php echo $lngU; ?>')" class="ui-btn ui-shadow ui-corner-all ui-icon-location ui-btn-icon-right boton">Ubicar en Mapa</a></center>
